...
| Phase 3: LinkedIn 카드뉴스 | **진행 중** (3-1~3-5 완료, 테스트 101개, 2026-09-15) | 방식 A안 확정(사람이 게시), 디자인 템플릿 수령·분석 완료. 카드는 1080×1350, 소개 5장·정기 5장 이상(마무리 안내 장 포함, D20) | `docs/phases/phase-3-linkedin.md`, `docs/plans/phase3-card-design.md`, `docs/plans/phase3-linkedin-cardnews.md` |
...
**다음 행동:** 3-6 계획 승인(2026-09-15). Step 0 검토 PR 본문 스크립트(`docs/scripts/review-pr-script.md`)를 `/humanize-korean`으로 점검했고 **문안 승인을 기다린다.** 승인 뒤 구현하고, push·시뮬레이션 실행(규칙 4)에서 한 번 더 승인을 받는다. 3-5의 회귀 결함(게시 워크플로가 승인일을 읽지 못함)을 push 전에 고친다.
...
- [ ] 3-6 (C) 워크플로 연결(검토 PR에 카드 표시, 머지 후 게시). 계획 승인(2026-09-15), Step 0 문안 승인 대기
