...
**다음 행동:** 3-8 계획과 결정 D21·D22가 승인됐다. Step 0 소개 4장 보완 문안을 `docs/scripts/cards-script.md`에 반영하고 점검했으며 **문안 승인을 기다린다.** 승인 뒤 구현하고, 카드 실물과 push(규칙 4)에서 한 번씩 더 승인을 받는다. 로컬에만 있는 기록 커밋은 다음 push 때 함께 올린다.
...
- [ ] 3-8 (C) 소개 카드 구현. 계획·D21·D22 승인(2026-09-15), 4장 보완 문안 승인 대기
- [ ] 3-9 (C) 종단 검증
