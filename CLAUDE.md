...
>   - **Phase 3 진행 중:** 방식 A안, 계획 3건 승인. 3-1(굽기 실측)·3-2(카드 스크립트, 2026-09-14 개정본 확정) 완료. 3-3 세부 계획 승인(2026-09-15), Step 0 보완 문안 승인 대기.
...
| Phase 3: LinkedIn 카드뉴스 | **진행 중** (3-1·3-2 완료, 3-3 Step 0 문안 승인 대기, 2026-09-15) | 방식 A안 확정(사람이 게시), 디자인 템플릿 수령·분석 완료. 카드는 1080×1350, 소개 5장·정기 5장 이상(마무리 안내 장 포함, D20) | `docs/phases/phase-3-linkedin.md`, `docs/plans/phase3-card-design.md`, `docs/plans/phase3-linkedin-cardnews.md` |
...
**다음 행동:** 3-3 세부 계획이 권고안대로 승인됐다(2026-09-15). Step 0 스크립트 보완과 `/humanize-korean` 점검(run `2026-09-15-001`, 게이트 수렴)을 마쳤다. **보완 문안 승인을 기다린다.** 승인 전에는 코드를 쓰지 않는다(규칙 16). 승인 후 Step 1(테스트 작성)부터 진행한다.
...
- [ ] 3-3 (C) 카드 데이터와 게시문 `publish/card_data.py`, `publish/render_linkedin.py`. 세부 계획 승인(2026-09-15). Step 0 보완 문안 승인 대기
