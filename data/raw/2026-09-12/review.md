...
# 중간 검토 보고서 · 2026-09-12

> **파이프라인은 여기서 멈춰 있습니다.** 아래 내용을 확인하고 판단해 주세요.
> - **컨펌:** GitHub 검토 PR이면 **Merge**. 로컬이면 `.venv\Scripts\python.exe pipeline.py --confirm 2026-09-12` → 화면 생성, 승인 기록(`approved.txt`) → 스냅샷 커밋
> - **반려:** GitHub 검토 PR이면 **Close**. 로컬이면 `data/raw/2026-09-12/` 폴더를 커밋하지 말고 지운 뒤, 원인을 고쳐 `pipeline.py`를 다시 실행
...
| databricks | compute | sql-serverless-dbu | seoul | 0.95 | DBU-hour | 2026-09-12 | https://prices.azure.com/api/retail/prices |
| databricks | compute | sql-serverless-dbu | us | 0.7 | DBU-hour | 2026-09-12 | https://prices.azure.com/api/retail/prices |
| databricks | storage | adls-hot-lrs | seoul | 0.02 | GB-month | 2026-09-12 | https://prices.azure.com/api/retail/prices |
| databricks | storage | adls-hot-lrs | us | 0.0208 | GB-month | 2026-09-12 | https://prices.azure.com/api/retail/prices |
| redshift | compute | serverless-rpu | seoul | 0.438 | RPU-hour | 2026-09-12 | https://pricing.us-east-1.amazonaws.com/offers/v1.0/aws/AmazonRedshift/20260911124505/ap-northeast-2/index.json |
| redshift | compute | serverless-rpu | us | 0.39375 | RPU-hour | 2026-09-12 | https://pricing.us-east-1.amazonaws.com/offers/v1.0/aws/AmazonRedshift/20260911124505/us-east-1/index.json (simulated) |
| redshift | storage | managed-storage | seoul | 0.0261 | GB-month | 2026-09-12 | https://pricing.us-east-1.amazonaws.com/offers/v1.0/aws/AmazonRedshift/20260911124505/ap-northeast-2/index.json |
| redshift | storage | managed-storage | us | 0.024 | GB-month | 2026-09-12 | https://pricing.us-east-1.amazonaws.com/offers/v1.0/aws/AmazonRedshift/20260911124505/us-east-1/index.json |
